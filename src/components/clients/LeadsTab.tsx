...
const STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  accepted: { label: '✅ Accepted', className: 'bg-emerald-100 text-[#3A7560]' },
  client_accepted: { label: '✅ Accepted', className: 'bg-emerald-100 text-[#3A7560]' },
  awaiting_schedule_approval: { label: '✅ Accepted', className: 'bg-emerald-100 text-[#3A7560]' },
